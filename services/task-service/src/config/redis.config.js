...
import { TaskIndexSchema } from '../models/index.js';
import { TASK_INDEX_NAME, TASK_PREFIX } from '../utils/index.js';
...
const initializeRedis = async () => {
    try {
        ...
        await ensureIndex(TaskIndexSchema, TASK_INDEX_NAME, TASK_PREFIX);
    } catch (error) {
